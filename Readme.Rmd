...
2. Accept the connection by typing 'yes'
3. Enter your GWDG userID (if prompted) and your password
...
a. Creating a job script
b. Submitting the job script to a GWDG queue for execution
